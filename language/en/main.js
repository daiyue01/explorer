module.exports = {
    ...
    hash_power_title: "<p>Whole network target hashrate: <b>{{target_hashpower}}</b>, Current Hashrate: <b>{{current_hashpower}}</b>，Fluctuation in all historys + recent 30 days:</p>",
